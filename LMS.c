...
// System Functions
    ...
    int bookStock = 0;
    char rentName[500], bookName[500];
...
void changePassword() {
    char oldPassword[255];
    char newPassword[255];
    char newPasswordConfirm[255];
    ...
    if (strcmp(oldPassword, "Rahat") != 0) {
        printf("Old password is incorrect. Password change failed.\n");
        Sleep(2000);
        menu();
        return;
    }
    ...
    gets(newPasswordConfirm);

    // Check if the new password and the confirmation match
    if (strcmp(newPassword, newPasswordConfirm) != 0) {
        printf("New password and confirmation do not match. Password change failed.\n");
        Sleep(2000);
        menu();
        return;
    }
...
void userPanel(){
    ...
    printf("%80s\n", "-----------------------------------------------\n");
    printf("%80s\n", ">>> Library Management System - User Panel <<< \n");
    printf("%80s\n", "-----------------------------------------------\n\n");
    printf("\t\t\t\t\t[1]=> Add User \n");
    printf("\n");
...
void bookPanel(){
    ...
    printf("%80s\n", "-----------------------------------------------\n");
    printf("%80s\n", ">>> Library Management System - Book Panel <<< \n");
    printf("%80s\n", "-----------------------------------------------\n\n");
    printf("\t\t\t\t\t[1]=> Add Book \n");
    printf("\n");
...
void endScreen(){
    ...
    printf("----------------------------------------------\n");
    printf("    >>> Creator: @Rahat Ashrafi  <<< \n");
    printf("----------------------------------------------\n\n");

    printf("> Facebook: https://www.facebook.com/rahat.ashrafi.dip \n");
    printf("\n");
    printf("> LinkedIn: https://www.linkedin.com/in/Rahat Ashrafi \n\n");
...
void addUser(){
    ...
    if(pF != NULL)
    {
        ...
        fgets(fname, sizeof(fname), stdin); // using fgets() instead of gets()

        printf("\t\t  --->>  Enter the Last Name: ");
        fgets(lname, sizeof(lname), stdin); // using fgets() instead of gets()
...
label3:
    ...
    char name[500], author[500], publisher[500];
